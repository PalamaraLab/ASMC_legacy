...
**This repository contains the code and example files for the ASMC program. A user manual can be found [here](https://palamaralab.github.io/software/asmc/), data and annotations from the paper can be found [here](https://palamaralab.github.io/software/asmc/data/).**
